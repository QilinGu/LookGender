...
template <typename _Tp>
void uniformPatternHistogram_(const Mat& src, Mat& hist, int numPatterns);
...
void uniformPatternSpatialHistogram(const Mat& src, Mat& spatialhist, int numPatterns, const Size& window, int overlap=0);

// wrapper functions
void spatial_histogram(const Mat& src, Mat& spatialhist, int numPatterns, int gridx=8, int gridy=8, int overlap=0);
void uniformPatternSpatialHistogram(const Mat& src, Mat& spatialhist, int numPatterns, int gridx=8, int gridy=8, int overlap=0);
void histogram(const Mat& src, Mat& hist, int numPatterns);
void uniformPatternHistogram(const Mat& src, Mat& hist, int numPatterns);
...
Mat uniformPatternSpatialHistogram(const Mat& src, int numPatterns, const Size& window, int overlap=0);
Mat spatial_histogram(const Mat& src, int numPatterns, int gridx=8, int gridy=8, int overlap=0);
Mat uniformPatternSpatialHistogram(const Mat& src, int numPatterns, int gridx=8, int gridy=8, int overlap=0);
